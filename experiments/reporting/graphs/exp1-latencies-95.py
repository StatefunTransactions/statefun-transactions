...
plt.bar(0.05 + 3*bar_width, 812, bar_width,
edgecolor=color_two,
fill=False,
hatch=hatch_write)
...
xpos = [
    ...
    0.1 + 5*bar_width, 
    0.2 + 7*bar_width,  0.225 + 8*bar_width, 
    0.25 + 9*bar_width
]
plt.xticks(xpos, x, fontsize=14)


plt.xlim(-0.05, 0.3 + 10*bar_width)
...
ax = plt.gca()
ax.legend([read_patch, write_patch], ['read', 'write'], loc='lower left')
