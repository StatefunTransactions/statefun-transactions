...
### 100 keys 0.1
plt.bar(0, np.median(SAGAS_REGULAR_100_10), bar_width,
edgecolor=color_sagas,
color=color_sagas)

plt.bar(bar_width, np.median(SAGAS_TRANSFER_100_10), bar_width,
edgecolor=color_sagas,
fill=False,
hatch=hatch_transfer)

plt.bar(2*bar_width, np.median(TPC_REGULAR_100_10), bar_width,
edgecolor=color_tpc,
color=color_tpc)

plt.bar(3*bar_width, np.median(TPC_TRANSFER_100_10), bar_width,
edgecolor=color_tpc,
fill=False,
hatch=hatch_transfer)

### 100 keys 0.5
plt.bar(4.5*bar_width, np.median(SAGAS_REGULAR_100_50), bar_width,
edgecolor=color_sagas,
color=color_sagas)

plt.bar(5.5*bar_width, np.median(SAGAS_TRANSFER_100_50), bar_width,
edgecolor=color_sagas,
fill=False,
hatch=hatch_transfer)

plt.bar(6.5*bar_width, np.median(TPC_REGULAR_100_50), bar_width,
edgecolor=color_tpc,
color=color_tpc)

plt.bar(7.5*bar_width, np.median(TPC_TRANSFER_100_50), bar_width,
edgecolor=color_tpc,
fill=False,
hatch=hatch_transfer)

### 100 keys 1
plt.bar(9*bar_width, np.median(SAGAS_TRANSFER_100_100), bar_width,
edgecolor=color_sagas,
fill=False,
hatch=hatch_transfer)

plt.bar(10*bar_width, np.median(TPC_TRANSFER_100_100), bar_width,
edgecolor=color_tpc,
fill=False,
hatch=hatch_transfer)
...
### 5000 keys 0.1
plt.bar(13*bar_width, np.median(SAGAS_REGULAR_5000_10), bar_width,
edgecolor=color_sagas,
color=color_sagas)

plt.bar(14*bar_width, np.median(SAGAS_TRANSFER_5000_10), bar_width,
edgecolor=color_sagas,
fill=False,
hatch=hatch_transfer)

plt.bar(15*bar_width, np.median(TPC_REGULAR_5000_10), bar_width,
edgecolor=color_tpc,
color=color_tpc)

plt.bar(16*bar_width, np.median(TPC_TRANSFER_5000_10), bar_width,
edgecolor=color_tpc,
fill=False,
hatch=hatch_transfer)

### 5000 keys 0.5
plt.bar(17.5*bar_width, np.median(SAGAS_REGULAR_5000_50), bar_width,
edgecolor=color_sagas,
color=color_sagas)

plt.bar(18.5*bar_width, np.median(SAGAS_TRANSFER_5000_50), bar_width,
edgecolor=color_sagas,
fill=False,
hatch=hatch_transfer)

plt.bar(19.5*bar_width, np.median(TPC_REGULAR_5000_50), bar_width,
edgecolor=color_tpc,
color=color_tpc)

plt.bar(20.5*bar_width, np.median(TPC_TRANSFER_5000_50), bar_width,
edgecolor=color_tpc,
fill=False,
hatch=hatch_transfer)

### 5000 keys 1
plt.bar(22*bar_width, np.median(SAGAS_TRANSFER_5000_100), bar_width,
edgecolor=color_sagas,
fill=False,
hatch=hatch_transfer)

plt.bar(23*bar_width, np.median(TPC_TRANSFER_5000_100), bar_width,
edgecolor=color_tpc,
fill=False,
hatch=hatch_transfer)
...
plt.tight_layout()
plt.savefig('graphs/exp2-latencies-median.pdf')
plt.show()